      ...
      <div className="container">
        ...
        <div className="hero-split">
          ...
          <ul className="hero-stack-list">
            <li><span className="stack-dot green" />{t.stackGit}</li>
            <li><span className="stack-dot blue" />{t.stackWeb}</li>
            <li><span className="stack-dot purple" />{t.stackMedia}</li>
            <li><span className="stack-dot orange" />{t.stackRuntime}</li>
            <li><span className="stack-dot cyan" />{t.stackDatabase}</li>
