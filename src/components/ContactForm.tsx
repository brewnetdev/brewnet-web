    ...
    <div className="contact-form">
      ...
      <form ref={formRef} onSubmit={handleSubmit}>
        <div className="form-grid">
          ...
          <div>
            <label htmlFor="contact-phone">{t.labelPhone}</label>
            <input
              id="contact-phone"
              type="tel"
              name="phone"
          ...
          <div className="form-full">
            <label htmlFor="contact-subject">{t.labelSubject}</label>
            <select id="contact-subject" name="subject" required defaultValue="">
              ...
              <option value="feature">{t.optionFeature}</option>
              <option value="partnership">{t.optionPartnership}</option>
              <option value="enterprise">{t.optionEnterprise}</option>
              <option value="other">{t.optionOther}</option>
            </select>
          </div>
          <div className="form-full">
            <label htmlFor="contact-message">{t.labelMessage}</label>
            <textarea
              id="contact-message"
              name="message"
              rows={5}
      ...
      <div style={{ marginTop: 24 }}>
        ...
        >
          ...
          <div>
            <h3 style={{ fontSize: "inherit", fontWeight: "inherit", margin: 0 }}>{t.telegramTitle}</h3>
            <p>{t.telegramDesc}</p>
          </div>
        </a>
      </div>
