...
export const cliCommands: {
  ...
  { command: "brewnet admin", description: { en: "Open web dashboard", ko: "웹 대시보드 열기" } },
  { command: "brewnet domain connect", description: { en: "Connect custom domain", ko: "커스텀 도메인 연결" } },
  ...
  { command: "brewnet shutdown", description: { en: "Graceful shutdown all services", ko: "모든 서비스 안전 종료" } },
