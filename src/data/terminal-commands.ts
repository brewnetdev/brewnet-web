export const terminalCommands = [
  {
    ...
    output: [
      ...
      '<span class="out-green">&#10003;</span> <span class="out-bold">Domain</span> <span class="out-muted">&mdash; my-server.cloudflare.dev + Cloudflare Tunnel</span>',
      ...
      '  Dashboard  <span class="out-cyan">https://my-server.cloudflare.dev</span>',
      '  Nextcloud  <span class="out-cyan">https://files.my-server.cloudflare.dev</span>',
      '  Gitea      <span class="out-cyan">https://git.my-server.cloudflare.dev</span>',
    ],
  },
  {
    cmd: "brewnet status",
    output: [
      ...
      '<span class="out-green">traefik</span>        <span class="out-green">running</span>     80/443  <span class="out-cyan">my-server.cloudflare.dev</span>',
      '<span class="out-green">postgresql</span>     <span class="out-green">running</span>     5432    <span class="out-muted">internal</span>',
      '<span class="out-green">nextcloud</span>      <span class="out-green">running</span>     8080    <span class="out-cyan">files.my-server.cloudflare.dev</span>',
      '<span class="out-green">gitea</span>          <span class="out-green">running</span>     3000    <span class="out-cyan">git.my-server.cloudflare.dev</span>',
  ...
  },
  {
    ...
    output: [
      ...
      '<span class="out-green">&#10003;</span> Route: <span class="out-cyan">https://media.my-server.cloudflare.dev</span>',
      "",
